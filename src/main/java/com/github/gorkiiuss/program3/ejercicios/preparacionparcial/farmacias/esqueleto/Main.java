...
public class Main {
	...
	private static String FICHERO_FARMACIAS = "/ejercicios/preparacionparcial/farmacias/farmaciasguardia.dat";
	...
	public static void cargaFarmacias() {
		...
		miVentana.setTitle( "Farmacias de guardia del d�a " + mapaActual.getDia() + "/" + mapaActual.getMes() );
	}
